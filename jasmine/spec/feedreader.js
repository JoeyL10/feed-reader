   ...
   describe('The Menu', function() {
       ...
       it('menu must be hidden by default', function() {
             expect($('body').hasClass('menu-hidden')).toBe(true);
              // DOM loads with menu-hidden class.  Once clicked
              // it gets removed. This checks to see if body element
              // loads with menu-hidden class.
    ...
    /* TODO: Write a new test suite named "New Feed Selection" */
     describe('New Feed Selection', function() {
         ...
         */
         ...
         beforeEach(function(done) {
           loadFeed(1, done);  // load css tricks blog feed
         ...
         it('feed content changes on update', function(done) {
             loadFeed(2);  // then load html rocks feed to change feedContent
